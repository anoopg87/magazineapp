...
public class Facts {
     ...
     * Contain one String title and one List<Row> variables to store the values retrieved from webservice
     * Variable name should be same as the key name of the Json response
     *
